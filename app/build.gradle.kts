...
android {
    namespace = "com.example.learningkotlinn4"
    compileSdk = 34
    packagingOptions {
        exclude("META-INF/DEPENDENCIES")
    }
    defaultConfig {
        applicationId = "com.example.learningkotlinn4"
        minSdk = 29
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("com.itextpdf:itext7-core:8.0.3") // Replace "7.x.x" with the latest version
